...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['projects2'] = Project::where('language_id', $lang_id)->take(2)->get();
        $data['testimonials'] = Testimonial::where('language_id', $lang_id)->get();
        $data['posts'] = Post::where('language_id', $lang_id)->get();
        //$data['videos'] = Youtube::listChannelVideos('UCbmvWkPjSrSW_-chmUq9-Jg', 0, "date");

        return view('home', compact('teams', 'clients', 'langs'), $data);
    }
    ...
    public function about()
    {
        ...
        return view('about', $data, compact('members', 'langs'));
    }
    ...
    public function booking()
    {
        ...
        return view('booking', $data, compact('langs'));
    }
    ...
    public function bookingPost(Request $request)
    {
        ...
        return back()->with('success', 'Благодарим Ви, резервацията Ви е записана. Очаквайте потвърждение!');
    }
