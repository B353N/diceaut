...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::post('/booking', [HomeController::class, 'bookingPost'])->name('bookingPost');
...
Route::middleware(['admin'])->group(function () {
    ...
    Route::post('admin/bookPost', [CalendarController::class, 'bookPost'])->name('adminBook');
    Route::get('admin/calendar', [CalendarController::class, 'index'])->name('admin.booking');
    ...
    Route::delete('/delete/team', [TeamController::class, 'delete_team'])->name('delete.team');
