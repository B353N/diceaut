...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.all_clients'), ['Attr.EnableID' => true]) }}
        </h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    {{ clean(trans('niva-backend.all_clients'), ['Attr.EnableID' => true]) }}</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">

                    <a href="{{ route('about-setting.edit') }}"
                        class="btn btn-primary btn-back">{{ clean(trans('niva-backend.back_aboutpage'), ['Attr.EnableID' => true]) }}</a>
                    <a href="{{ route('contact-setting.edit') }}"
                        class="btn btn-primary btn-back">{{ clean(trans('niva-backend.back_contact_page'), ['Attr.EnableID' => true]) }}</a>
                                    ...
                                    @foreach ($clients as $client)
                                        <tr>
                                            ...
                                            <td><img height="100"
                                                    ...
                                                    alt="">
                                                <p class="mb-0 mt-2"><a
                                                        href="{{ route('client.edit', $client->id) }}">{{ clean(trans('niva-backend.edit'), ['Attr.EnableID' => true]) }}</a>
                                                </p>
                                            </td>
