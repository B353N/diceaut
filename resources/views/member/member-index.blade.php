...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.all_members'), ['Attr.EnableID' => true]) }}
        </h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    {{ clean(trans('niva-backend.all_members'), ['Attr.EnableID' => true]) }}</h6>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ clean(trans('niva-backend.position'), ['Attr.EnableID' => true]) }}</th>
                                </tr>
                            </thead>
                            <tfoot>
                                <tr>
                                    ...
                                    @foreach ($members as $member)
                                        <tr>
                                            ...
                                            <td><img height="100"
                                                    ...
                                                    alt="">
                                                <p class="mb-0 mt-2"><a
                                                        href="{{ route('member.edit', $member->id) }}">{{ clean(trans('niva-backend.edit'), ['Attr.EnableID' => true]) }}</a>
                                                </p>
                                            </td>
