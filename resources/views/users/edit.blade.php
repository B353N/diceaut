...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.edit_user'), ['Attr.EnableID' => true]) }}</h1>
            ...
            <div class="card-body">
                ...
                @if (Auth::user()->role->name == 'administrator')
                    <a href="{{ route('users.index') }}"
                        class="btn btn-primary btn-back">{{ clean(trans('niva-backend.back_user'), ['Attr.EnableID' => true]) }}</a>
                @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        @else
                                            <strong>{{ clean(trans('niva-backend.roles'), ['Attr.EnableID' => true]) }}</strong>
                                            <select name="role_id" id="role_id" class="form-control">
                                                <option>
                                                    {{ clean(trans('niva-backend.choose_role'), ['Attr.EnableID' => true]) }}
                                                </option>
                                                @foreach ($roles as $role)
                                                    <option @if ($user->role_id == $role->id) { selected="selected" } @endif
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" value="{{ $user->address }}"
                                            class="form-control"
                                            placeholder="{{ clean(trans('niva-backend.address'), ['Attr.EnableID' => true]) }}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{ clean(trans('niva-backend.city'), ['Attr.EnableID' => true]) }}</strong>
                                        <input type="text" name="city" value="{{ $user->city }}"
                                            class="form-control"
                                            placeholder="{{ clean(trans('niva-backend.city'), ['Attr.EnableID' => true]) }}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{ clean(trans('niva-backend.change_password'), ['Attr.EnableID' => true]) }}</strong>
                                        <input type="password" name="password" class="form-control"
                                            placeholder="{{ clean(trans('niva-backend.change_password'), ['Attr.EnableID' => true]) }}">
                                    </div>
                                </div>
