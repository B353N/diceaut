...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.all_users'), ['Attr.EnableID' => true]) }}</h1>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    {{ clean(trans('niva-backend.all_users'), ['Attr.EnableID' => true]) }}</h6>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ clean(trans('niva-backend.email'), ['Attr.EnableID' => true]) }}</th>
                                    <th>{{ clean(trans('niva-backend.role'), ['Attr.EnableID' => true]) }}</th>
                                </tr>
                            </thead>
                            <tfoot>
                                <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Name">
                                                ...
                                                <div class="float-left-user-name">
                                                    <p>{{ $user->name }}</p>
                                                    <a
                                                        href="{{ route('users.edit', $user->id) }}">{{ clean(trans('niva-backend.edit'), ['Attr.EnableID' => true]) }}</a>
                                                </div>
                                            </td>
