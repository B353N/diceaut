...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.edit_slider'), ['Attr.EnableID' => true]) }}
        </h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    {{ clean(trans('niva-backend.edit_slider'), ['Attr.EnableID' => true]) }}</h6>
            </div>
            <div class="card-body">

                <a href="{{ route('slider.index') . '?language=' . request()->input('language') }}"
                    class="btn btn-primary btn-back">{{ clean(trans('niva-backend.back_slider'), ['Attr.EnableID' => true]) }}
                </a>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{ clean(trans('niva-backend.heading_1'), ['Attr.EnableID' => true]) }}</strong>
                                                <input type="text" name="heading1" class="form-control"
                                                    value="{{ $slider->heading1 }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{ clean(trans('niva-backend.heading_2'), ['Attr.EnableID' => true]) }}</strong>
                                                <input type="text" name="heading2" class="form-control"
                                                    value="{{ $slider->heading2 }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <img class="img-fluid pb-4" width="100" height="100"
                                            src="{{ $slider->photo ? '/images/media/' . $slider->photo->file : '/img/200x200.png' }}">
