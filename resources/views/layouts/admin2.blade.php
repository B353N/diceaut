...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#0">
                ...
                <div class="sidebar-brand-text mx-3">ProWebsite<sup>v1.0</sup></div>
            </a>
            ...
            @if (Auth::user()->role->name == 'administrator')
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseElements" class="collapse" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item"
                                href="{{ route('slider.index') }}?language=@php echo $lang->code; @endphp">Управление
                                слайдър</a>
                            <a class="collapse-item"
                                href="{{ route('team.index') }}?language=@php echo $lang->code; @endphp">Управление на
                                екипа</a>
                            <a class="collapse-item"
                                href="{{ route('service.index') }}?language=@php echo $lang->code; @endphp">Управление
                                услуги</a>
                            <a class="collapse-item"
                                href="{{ route('testimonial.index') }}?language=@php echo $lang->code; @endphp">Управление
                                мнения</a>
                            <a class="collapse-item"
                                href="{{ route('client.index') }}?language=@php echo $lang->code; @endphp">Управление
                                клиенти</a>
                        </div>
                    </div>
                </li>
    ...
    <script src="{{ asset('js/evo/evo-calendar.js') }}"></script>
