...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.edit_page'), ['Attr.EnableID' => true]) }}</h1>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <img class="img-fluid pb-4" width="100" height="100"
                                            src="{{ $page->photo ? '/images/media/' . $page->photo->file : '/public/img/200x200.png' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="body" class="form-control" id="body" rows="5">{{ clean($page->body, ['Attr.EnableID' => true]) }}</textarea>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_description" class="form-control"
                                                    placeholder="" value="{{ $page->meta_description }}">
                                            </div>
                                        </div>
                                    </div>
