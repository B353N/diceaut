    ...
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.home_settings') , array('Attr.EnableID' => true))}}</h1>
                ...
                <div class="row">
                	...
                	<div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('home-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.services_subtitle') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="services_subtitle" class="form-control" value="{{$setting->services_subtitle}}">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('niva-backend.section_separator') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{route('home-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.title') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="separator_title" class="form-control" value="{{$setting->separator_title}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.separator_description') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="separator_description" class="form-control" value="{{$setting->separator_description}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.separator_button1_text') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="separator_button1_text" class="form-control" value="{{$setting->separator_button1_text}}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.separator_button1_link') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="separator_button1_link" class="form-control" value="{{$setting->separator_button1_link}}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.separator_button2_link') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="separator_button2_link" class="form-control" value="{{$setting->separator_button2_link}}">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('niva-backend.section_workflow') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                        		<form action="{{route('home-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
        					        @csrf
